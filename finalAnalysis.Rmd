<span font-size=0.2em, line-height=0.2>
<strong>Report: Motor Trend Analysis of MPG Covariates by Transmission Type</strong><br>
...
Finally, we can run a quick diagnostic on our models using residual plots.  These can be seen in __Figures 4 - 6__.  All of the plots are appropriately random, indicating that the model variables are not being confounded.
