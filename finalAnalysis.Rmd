...
plot(mtcars$am, mtcars$mpg, pch=19, col=ifelse(mtcars$am==1, "salmon", "steelblue"), xlab="Transmission Type", ylab="Miles per Gallon")
...
<br>
<h5>Figure 3: MPG by Engine Displacement and Transmission Type</h5>
```{r, echo=FALSE, fig.height=3.5, fig.width=3.5}
par(mar=c(5.1, 4.1, 0, 2.1))
plot(mtcars$disp, mtcars$mpg, pch=19, col=ifelse(mtcars$am==1, "salmon", "steelblue"), xlab="Displacement", ylab="MPG")
